...
from secrets import binusmaya_password, binusmaya_username
...
payload = {'Username': binusmaya_username, 'Password': binusmaya_password}
...
while len(TODAY_CLASS_LIST) > 0:
    ...
    ss.screenshot(next_class_end_time)
